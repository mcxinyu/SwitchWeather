...
public class SettingFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // mLocationProvider = new LocationProvider(SwitchWeatherApp.getInstance());
    ...
    private void initPreferences() {
        ...
        settingNotificationWidget = (SwitchPreference) findPreference(QueryPreferences.SETTING_NOTIFICATION_SERVICE);
    ...
    private void initPreferenceSummary() {
        ...
        if (settingLocationCity.isChecked()) {
            if (QueryPreferences.getLocationCityName(SwitchWeatherApp.getInstance()) == null) {
                getPermissions();
                // mLocationProvider.start();
            } else {
                settingLocationCity.setSummary(QueryPreferences.getLocationCityName(SwitchWeatherApp.getInstance()));
            }
        } else {
        ...
        switch (key) {
            case QueryPreferences.SETTING_LOCATION_CITY:
                if (settingLocationCity.isChecked()) {
                    ...
                    QueryPreferences.setLocationCityName(getActivity(), "");
                    settingLocationCity.setSummary("");
    ...
    //     NotificationManager notificationManager = (NotificationManager) getActivity().getSystemService(Context.NOTIFICATION_SERVICE);
    //     String locationCityId = QueryPreferences.getLocationCityId(SwitchWeatherApp.getInstance());
    //     if (isChecked && ((null == locationCityId) || ("".equals(locationCityId)))) {
    //         settingNotificationWidget.setChecked(false);
    ...
    //         WeatherInfo weatherInfo = WeatherDatabaseLab.get(SwitchWeatherApp.getInstance()).getWeatherInfoWithCityName(locationCityId);
    //         Resources resources = getResources();
    //
    //         Intent intent = WeatherActivity.newIntent(SwitchWeatherApp.getInstance(), weatherInfo.getBasicCityId());
    //         PendingIntent pendingIntent = PendingIntent.getActivity(SwitchWeatherApp.getInstance(), REQUEST_CODE_NOTIFICATION_WIDGET, intent, 0);
    //
    //         String tmpNow;
    //         String tmpMin;
    //         String tmpMax;
    ...
    //
    //         Notification notification = new NotificationCompat.Builder(SwitchWeatherApp.getInstance())
