...
import io.github.mcxinyu.switchweather.database.WeatherDbSchema.CityTable;
import io.github.mcxinyu.switchweather.database.WeatherDbSchema.ConditionTable;
import io.github.mcxinyu.switchweather.database.WeatherDbSchema.DailyForecastTable;
import io.github.mcxinyu.switchweather.database.WeatherDbSchema.HourlyForecastTable;
import io.github.mcxinyu.switchweather.database.WeatherDbSchema.WeatherInfoTable;
...
import io.github.mcxinyu.switchweather.model.HeWeatherModel.HeWeather5Bean;
import io.github.mcxinyu.switchweather.model.HeWeatherModel.HeWeather5Bean.DailyForecastBean;
import io.github.mcxinyu.switchweather.model.HeWeatherModel.HeWeather5Bean.HourlyForecastBean;
 ...
 */
@Deprecated
public class WeatherDatabaseLab {
    private static WeatherDatabaseLab sWeatherLab;
    private Context mContext;
    private SQLiteDatabase mDatabase;

    public static WeatherDatabaseLab get(Context context) {
        if (sWeatherLab == null) {
            sWeatherLab = new WeatherDatabaseLab(context);
        }
        return sWeatherLab;
    }

    private WeatherDatabaseLab(Context context) {
        mContext = context;
    ...
    public void addDailyForecastList(HeWeatherModel weatherModel) {
    ...
    public void addHourlyForecastList(HeWeatherModel weatherModel) {
        String cityId = weatherModel.getHeWeather5().get(0).getBasic().getId();
    ...
    public void addWeatherInfo(HeWeatherModel weatherModel) {
        String cityId = weatherModel.getHeWeather5().get(0).getBasic().getId();
    ...
    // -------- 修改 --------
    // public void updateDailyForecastList(HeWeatherModel weatherModel){
    //     String cityId = weatherModel.getHeWeather5().get(0).getBasic().getId();
    //
    //     List<ContentValues> valuesList = getDailyForecastListValues(weatherModel);
    //     for (int i = 0; i < valuesList.size(); i++) {
    //         String date = valuesList.get(i).getAsString(DailyForecastTable.Columns.DATE);
    //         MyCursorWrapper cursor = queryAllRows(DailyForecastTable.NAME,
    //              DailyForecastTable.Columns.CITY + "=? and " + DailyForecastTable.Columns.DATE + "=?",
    //              new String[]{cityId, date});
    //
    //         if (cursor.getCount() != 0){
    //             mDatabase.update(DailyForecastTable.NAME,
    ...
    // public void updateHourlyForecastList(HeWeatherModel weatherModel){
    //     String cityId = weatherModel.getHeWeather5().get(0).getBasic().getId();
    //     deleteHourlyForecastOldDate(cityId);
    //
    //     List<ContentValues> valuesList = getHourlyForecastListValues(weatherModel);
    ...
    //         String date = values.getAsString(HourlyForecastTable.Columns.DATE);
    //         mDatabase.update(HourlyForecastTable.NAME, values,
    //                 HourlyForecastTable.Columns.CITY + "=? and " + HourlyForecastTable.Columns.DATE + "=?",
    //                 new String[]{cityId, date});
    //     }
    // }

    // public void updateWeatherInfo(HeWeatherModel weatherModel){
    ...
    public List<HourlyForecast> getHourlyForecastList(String cityId) {
        ...
        // MyCursorWrapper wrapper = queryAllRows(HourlyForecastTable.NAME,
        //         HourlyForecastTable.Columns.CITY + "=? and " +
    ...
    private static List<ContentValues> getDailyForecastListValues(HeWeatherModel weatherModel) {
    ...
    private static List<ContentValues> getHourlyForecastListValues(HeWeatherModel weatherModel) {
    ...
    private static ContentValues getWeatherInfoValues(HeWeatherModel weatherModel) {
